...
![alt_text](https://github.com/felipebottega/Tensor-Fox/blob/master/readme_files/benchmarks2.png)
 ...
 Next, we make the same procudure but this time we fixed *n* to *n* = 10 and increased the order, from order 3 to 8. In other words, we consider random rank-5 tensors of shape 10 x 10 x 10, them 10 x 10 x 10 x 10, until 10 x 10 x 10 x 10 x 10 x 10 x 10 x 10.
