...
def precond(X, Y, Z, L, M, damp, m, n, p, r):
    ...
    It is a diagonal preconditioner designed to make Dres.transpose*Dres + Gamma unit diagonal. Since the 
    matrix is diagonally dominant, the result will be close to the identity matrix. Therefore, it will be
